...
if { $list_projs eq "" } {
   create_project picorv32 picorv32 -part xc7z020clg400-1
...
proc create_hier_cell_processor { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net PicoBramBridge_0_BRAM [get_bd_intf_pins riscvBram/BRAM_PORTA] [get_bd_intf_pins riscvBramBridge/BRAM]
  connect_bd_intf_net -intf_net picorv32_M_PBRAM_MEM [get_bd_intf_pins picorv32/M_PBRAM_MEM] [get_bd_intf_pins riscvBramBridge/S_PICOBRAM_MEM]

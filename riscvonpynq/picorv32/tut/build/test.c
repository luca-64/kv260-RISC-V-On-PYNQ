...
*** OK per simulazione con Ripes. Impostare indirizzo memoria in Ripes a 0x00001000 ***
...
// Indirizzo inizio segmento dati in RAM (secondo Kbyte, primo Kbyte contiene programma).
